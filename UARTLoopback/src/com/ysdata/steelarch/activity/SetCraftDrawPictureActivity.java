...
import com.ysdata.steelarch.manager.TempData;
import com.ysdata.steelarch.picture.utils.BitmapUtil;
import com.ysdata.steelarch.storage.ExtSdCheck;
import com.ysdata.steelarch.uart.MyActivityManager;
import com.ysdata.steelarch.view.DrawPictureView;
	...
	protected void onImportClick(View v)
	{
		...
		if (sdcarddir != null) {
			...
			if (imageExist(image_path)) {
				...
				Toast.makeText(context, "在外部sd卡的AngCollector/draw/image_demo/目录下未检测到示例图片。", Toast.LENGTH_SHORT).show();
			}
		} else {
