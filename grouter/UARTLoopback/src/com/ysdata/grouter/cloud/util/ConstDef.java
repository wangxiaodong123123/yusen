...
public class ConstDef {
	public static String PROJECT_NAME = "YS200/Grouter";
	public static String PKG_NAME = "com.ysdata.grouter";
	...
	public static int SYNCTIME_TYPE_IMAGES = 4;
	public static int SYNCTIME_TYPE_SUBPROJECTPOINT = 5;
	public static int SYNCTIME_TYPE_SUBPROJECTPOINT_GROUTING_DATA = 6;
