...
public class Format {
	...
	public final static int PANEL_HEAD = 0x9a;
	public final static int PANEL_BREAK = 0xa9;
	...
	public final static int CMD_MIX_REQUEST_INTERNET = 0x01; //控制面板联网请求
	public final static int CMD_MIX_DATA = 0x02; //来自搅拌仪的数据，搅拌时间、搅拌量、搅拌位置等
	public final static int CMD_MIX_RESULT_PIC = 0x03; //搅拌效果图
	public final static int CMD_MIX_SCENE_PIC = 0x04; //搅拌现场图
	
	// 平板->搅拌仪
	public final static int CMD_MIX_REQUEST_COMM_SEQ = 0x05; //搅拌参数
	public final static int CMD_MIX_CRAFT_DATA = 0x06; //搅拌参数
	public final static int CMD_MIX_REQUEST_ENG = 0x07; //搅拌参数
	public final static int CMD_MIX_COMM_STOP = 0x08; //接收控制面板数据传输结束
	
	public final static int HANDLER_REQUEST_INTERNET = 1;
	public final static int HANDLER_ENG_MATCH = 2;
	public final static int HANDLER_ENG_NOT_MATCH = 3;
	public final static int HANDLER_REQEST_TRANSFER_DATA_SUCCESS = 4;
	public final static int HANDLER_RECV_MIX_DATE = 5;
	public final static int HANDLER_RECV_FIRST_GROUP_MIX_PIC_RESULT = 6;
	public final static int HANDLER_RECV_GROUP_MIX_PIC_RESULT = 7;
	public final static int HANDLER_RECV_MIX_PIC_RESULT_SUCCESS = 8;
	...
	public final static int HANDLER_MIX_COMM_FINISH = 12;
